const PokemonModel = require('../src/model/pokemon.model')
...
db.pokemons.find({ $or: [{ hp: { $lt: 60 } }, { defense: { $lt: 60 } }] }, { name: 1, defense: 1, hp: 1, })
...
db.pokemons.find({ type1: { $in: ['psychic', 'fighting', 'fire'] } }, { _id: 0, name: 1, is_legendary: 1, type1: 1 })
